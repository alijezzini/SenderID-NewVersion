...
function getnote(Request $req){
    ...
    if ($notes->count() > 0) {
        ...
        $output .= '  
         <div id="note_row_'.$note->nt_id.'" style="overflow-y: scroll; padding:1rem; background-color:#E7E7E7;border-radius:10px;margin-bottom:0.5rem;border: 1px solid grey;">
           <div class="row">
